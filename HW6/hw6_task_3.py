...
@click.command()
@click.option('--from_article', default='Теория_струн', prompt='start',
              help='starting point')
@click.option('--to_article', default='Динамический_хаос', prompt='end',
              help='ending point')
@click.option('--n_threads', default=10, prompt='number of processes',
              help='number of processes (it will be doubled)')
